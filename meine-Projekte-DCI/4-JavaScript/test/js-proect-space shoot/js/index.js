...
window.onload = function () {
  ...
  startBtn.addEventListener('click', function (e) {
    ...
    meteoresImg.src = './img/Nayzak0.png'
    meteoresImg.onload = () => {
...
function meteorCreator(meteoresImg, somCtx, meteorX, meteorY) {
  ...
  let meteorInterval = setInterval(() => {
    theMeteor.y += 5
    somCtx.clearRect(theMeteor.x - 20, theMeteor.y - 30, 100, 100)
    somCtx.drawImage(meteoresImg, 0, 0, 700, 700, theMeteor.x, theMeteor.y, 100, 100)
    if (theMeteor.y == 500) {
      clearInterval(meteorInterval)
    }
